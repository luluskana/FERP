                        ...
                        <table id="tableSaleRequestList" class="table table-striped table-hover">
                            ...
                            <c:forEach var="faRequest" items="${faStatusSaleCoFollowUp}" varStatus="loop">
                                <tr>
                                    ...
                                    <td><a href="${home}fams/saleOutFollow/${faRequest.id}" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
