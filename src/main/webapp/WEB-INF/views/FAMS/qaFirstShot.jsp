                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-8">
                            <button type="button" id="btnApprove" class="btn btn-success">Approve First</button>
                            <button type="button" id="btnReject" class="btn btn-danger col-sm-offset-1">Reject First</button>
                        </div>
                    </div>
                </div>
            </form>
