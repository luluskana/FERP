                ...
                <div class="panel-body">
                    <div class="col-sm-12 table-responsive">
                        <table id="tableSaleRequestList" class="table table-striped table-hover">
                            ...
                            <tbody>
                            <c:forEach var="faRequest" items="${faStatusApproveFinal}" varStatus="loop">
                                <tr>
                                    <td>${loop.index + 1}</td>
                                    ...
                                    <td><a href="${home}fams/reviewDoc/${faRequest.id}" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
